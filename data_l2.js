const DATA = [
  ...
  },
  {
    ...
    "vidCount": "L1: 62",
    "vidRange": "L1 Videos 91–102, 131–136, 342–374, 544–554",
    ...
    "stops": [
      ...
      },
      {
        ...
        "range": "L1 Videos 360–374",
        "topics": "Reverse/Rotate/Inverse Array, Subarrays vs Subsets, Elementary Binary Search, Ceil & Floor, First & Last Index",
        "diff": "med",
        "type": "pep1"
      },
      {
        ...
        "topics": "Informal Big-O definition, O(1) vs O(N) vs O(N²), space overhead, nested loops analysis",
        "diff": "easy",
        "type": "supp"
      }
    ]
  ...
  {
    "title": "Phase 3: Essential Array & String Patterns",
    "vidCount": "L1: 8 · L2: 45",
    "vidRange": "L1: 460–466, 491 · L2: 107–121, 126–142, 146–150, 154–161",
    "readiness": "Can solve subarray sum problems using prefix sums/hashmaps and apply two pointers on sorted arrays.",
    "stops": [
      {
        "title": "HashMap & HashSet Foundations",
        "range": "L1 Videos 460–466, 491",
        "topics": "Highest Frequency Character, Get Common Elements (1 & 2), Longest Consecutive Sequence, Hash Table Lookup Intuition",
        "diff": "easy",
        "type": "pep1"
      },
      {
  ...
  {
    "title": "Phase 5: Bit Basics & Backtracking",
    "vidCount": "L1: 8 · L2: 69",
    "vidRange": "L1: 419–426 · L2: 1–66, 79–80, 82",
    ...
    "stops": [
      {
        ...
        "range": "L1 Concept / Supplement",
        "topics": "Bitwise AND/OR/XOR/NOT/Shifts, Check/Set/Clear/Toggle Bit, Check Power of 2, Brian Kernighan's Algorithm, Single Number, Subsets via Bitmask",
        "diff": "med",
        "type": "supp"
      },
      {
  ...
  {
    "title": "Phase 6: Linear Data Structures & Monotonic Patterns",
    ...
    "stops": [
      ...
      },
      {
        ...
        "topics": "Add/Subtract Two LLs Without Extra Space, Floyd Cycle Detection & Proof, Cycle Node, Intersection via Floyd, Copy List with Random Pointers, Segregate 01/012/Pivot Index, Complete Doubly Linked List (Add/Remove/Get/Display)",
        "diff": "hard",
        "type": "pep2"
      }
    ]
  ...
  {
    "title": "Phase 7: Trees & Hierarchical Structures",
    "vidCount": "L1: 147 · L2: 24",
    "vidRange": "L1: 214–216, 224–341, 432–439, 444–459, 467, 542 · L2: 165, 168, 174–176, 178–180, 189, 192–200, 214–217, 220, 222–223",
    ...
    "stops": [
      ...
      {
        "title": "Binary Trees",
        "range": "L1 Videos 311–341, 432–439",
        "topics": "Constructor, Recursive & Iterative Pre/In/Post/Level Order, Node-to-Root Path, Nodes K Away, Left Cloned Tree, Diameter, Tilt of Tree, Balanced Tree Check, Largest BST Subtree",
        "diff": "hard",
        "type": "pep1"
      },
      {
        ...
        "topics": "BST Invariant Rule, Add/Remove Node, Replace with Sum of Larger, LCA in BST, Print in Range, Target Sum Pair, Validate BST Range Check",
        "diff": "med",
        "type": "pep1"
      },
      {
        "title": "L2: Morris Traversal, Tree Construction & Views",
        "range": "L2 Videos 165, 168, 174–176, 178–180, 189, 192–200, 214–217, 220, 222–223",
  ...
  },
  {
    ...
    "vidCount": "L1: 15",
    "vidRange": "L1 Videos 468–478, 492–493, 500–501",
    ...
    "stops": [
      ...
      },
      {
        ...
        "range": "L1 Videos 500–501",
        "topics": "Array of Linked List Buckets, Hash Function, Rehash Threshold & Load Factor, Get/Put/Remove/ContainsKey Implementation",
        "diff": "hard",
        "type": "pep1"
      }
    ]
  ...
  {
    "title": "Phase 10: Dynamic Programming & String Sequences",
    "vidCount": "L1: 35 · L2: 48",
  ...
  {
    "title": "Phase 11: Graph Algorithms, Traversals & DSU",
    "vidCount": "L1: 17 · L2: 7",
  ...
  {
    "title": "Phase 13: Advanced Structures & Range Queries",
    "vidCount": "L2: 3",
